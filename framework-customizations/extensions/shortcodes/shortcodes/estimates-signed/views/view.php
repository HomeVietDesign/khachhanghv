...
if($current_client) {
	...
	if($contractor_cats) {
		?>
		<div class="fw-shortcode-estimates-signed">
			<div class="accordion">
			<?php
							...
							<div id="panels-<?=$key?>" class="accordion-collapse collapse show">
			      				<div class="accordion-body">
									...
									foreach($contractors as $i => $contractor_id) {
										if($per<=0 || $i<$per) {
											\FW_Shortcode_Estimates_Signed::display_contractor($contractor_id, $current_client, $progress, $contractor_hide, $contractor_signed);
										} else {
											break;
										}
									}
