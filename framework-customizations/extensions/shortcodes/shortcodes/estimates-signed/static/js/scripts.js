document.addEventListener('DOMContentLoaded', function(e){
	jQuery(function($){
		...
		$('.fw-shortcode-estimates-percent section.accordion-item').each(function(index, container){
		...
		$(document).on('click', '.fw-shortcode-estimates-percent section.accordion-item .pagination-link button', function(e){
			let $this = $(this),
