...
if($current_client) {
	...
	if($contractor_cats) {
		?>
		<div class="fw-shortcode-procedures">
			<div class="accordion">
			<?php
						...
						$_contractors = get_posts([
							...
							'tax_query' => [
								...
								'rating' => [
									...
									'field' => 'id',
									'terms' => fw_get_db_settings_option('contractor_rating_procedure')
								]
							]
						]);
						if($_contractors) {
							...
							<div id="panels-<?=$key?>" class="accordion-collapse collapse show">
			      				<div class="accordion-body">
									...
									foreach($contractors as $i => $contractor_id) {
										if($per<=0 || $i<$per) {
											\FW_Shortcode_Procedure::display_contractor($contractor_id, $current_client, $progress, $contractor_hide);
										} else {
											break;
										}
									}
