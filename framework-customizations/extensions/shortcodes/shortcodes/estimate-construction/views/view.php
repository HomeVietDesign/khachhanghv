...
$shortcode = fw_ext( 'shortcodes' )->get_shortcode('estimate_construction');
...
if($current_client) {
	...
	if($contractor_cats) {
		?>
		<div class="fw-shortcode-estimates-construction">
			<div class="accordion">
			<?php
						...
						$_contractors = get_posts([
							...
							'tax_query' => [
								...
								'rating' => [
									...
									'field' => 'id',
									'terms' => fw_get_db_settings_option('contractor_construction')
								]
							]
						]);
						if($_contractors) {
