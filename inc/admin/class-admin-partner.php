...
class Admin_Partner {
	...
	private function __construct() {
		...
		if(is_admin()) {
			...
			add_action( 'manage_partner_posts_custom_column', [ $this, 'custom_columns_value' ], 2, 2 );
			add_filter( 'manage_partner_posts_columns', [ $this, 'add_custom_columns_header' ] );
	...
	public function switch_boxes() {
		...
		remove_meta_box(
            'postexcerpt' // ID
        ,   'partner'            // Screen, empty to support all post types
        ,   'normal'      // Context
        );
        ...
        ,   'partner'              // Screen, we use all screens with meta boxes.
        ,   'normal'          // Context
        ,   'core'            // Priority
        );
	}
