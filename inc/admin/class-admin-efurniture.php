...
class Admin_Efurniture {
	...
	private function __construct() {
		...
		if(is_admin()) {
			...
			if(unyson_exists()) {
				add_action( 'fw_save_post_options', [$this, 'save_efurniture_15'], 15, 2 );
			} else {
				add_action( 'save_post_efurniture', [$this, 'save_efurniture_15'], 15, 2 );
			}
	...
	public function save_efurniture_15($post_id, $post) {
		if ($post->post_type!='efurniture') return;
		...
		if ( ! current_user_can( 'edit_efurniture', $post_id ) ) {
			return;
		}
