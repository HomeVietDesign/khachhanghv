...
class Admin_Investor {
	...
	private function __construct() {
		...
		if(is_admin()) {
			...
			add_action( 'created_investor', [$this, 'auto_slug'] );

			add_filter('manage_edit-investor_columns', [$this, 'custom_column_header']);
			//add_filter('manage_investor_custom_column', [$this, 'custom_column_value'], 10, 3);
	...
	public function enqueue_scripts($hook) {
		...
		if(($hook=='edit-tags.php' || $hook=='term.php') && $taxonomy=='investor') {
			wp_enqueue_style( 'manage-investor', THEME_URI.'/assets/css/manage-investor.css', [], '' );
			wp_enqueue_script('manage-investor', THEME_URI.'/assets/js/manage-investor.js', array('jquery'), '');
		}
	}
