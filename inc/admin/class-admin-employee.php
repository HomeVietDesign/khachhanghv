...
class Admin_Employees {
	...
	private function __construct() {
		...
		if(is_admin()) {
			...
			add_action( 'created_employee', [$this, 'auto_slug'] );

			add_filter('manage_edit-employee_columns', [$this, 'custom_column_header']);
			//add_filter('manage_employee_custom_column', [$this, 'custom_column_value'], 10, 3);
	...
	public function enqueue_scripts($hook) {
		...
		if(($hook=='edit-tags.php' || $hook=='term.php') && $taxonomy=='employee') {
			wp_enqueue_style( 'manage-employee', THEME_URI.'/assets/css/manage-employee.css', [], '' );
			wp_enqueue_script('manage-employee', THEME_URI.'/assets/js/manage-employee.js', array('jquery'), '');
		}
	}
