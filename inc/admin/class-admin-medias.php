...
class Admin_Medias {
	...
	private function __construct() {
		...
		if(is_admin()) {
			...
			if(unyson_exists()) {
				add_action( 'fw_save_post_options', [$this, 'save_media_15'], 15, 2 );
			} else {
				add_action( 'save_post_media', [$this, 'save_media_15'], 15, 2 );
			}
		}

	}

	public function save_media_15($post_id, $post) {
		...
		if ( ! current_user_can( 'edit_media', $post_id ) ) {
			return;
		}
