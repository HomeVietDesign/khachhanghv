...
class Admin_Work_Cats {
	...
	private function __construct() {
		...
		if(is_admin()) {
			...
			add_action( 'created_work_cat', [$this, 'auto_slug'] );

			add_filter('manage_edit-work_cat_columns', [$this, 'custom_column_header']);
			//add_filter('manage_work_cat_custom_column', [$this, 'custom_column_value'], 10, 3);
	...
	public function enqueue_scripts($hook) {
		...
		if(($hook=='edit-tags.php' || $hook=='term.php') && $taxonomy=='work_cat') {
			wp_enqueue_style( 'manage-work_cat', THEME_URI.'/assets/css/manage-work_cat.css', [], '' );
			wp_enqueue_script('manage-work_cat', THEME_URI.'/assets/js/manage-work_cat.js', array('jquery'), '');
		}
	}
