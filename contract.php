 ...
 * 
 */
if(current_user_can( 'contract_view' )) {
...
while (have_posts()) {
	...
	if($current_client) {
		?>
		<form id="contract-filter-form" action="<?=esc_url(fw_current_url())?>" method="GET">
						...
						<div class="filters d-flex justify-content-end align-items-center">
							<div class="filter-progress d-flex justify-content-end align-items-center">
								...
								<div class="filter-progress-item m-1 d-flex">
									...
									<label class="btn btn-sm btn-outline-yellow fw-bold" for="progress-created">Tạo: <span>0</span></label>
								</div>
								<div class="filter-progress-item m-1 d-flex">
								...
								<div class="filter-progress-item m-1 d-flex">
									<input type="checkbox" class="btn-check progress-checker" name="progress" value="signed" id="progress-signed" <?php checked( 'signed', $progress, true ); ?>>
									<label class="btn btn-sm btn-outline-green fw-bold" for="progress-signed">Đã ký: <span>0</span></label>
								</div>
							</div>
						</div>
					</div>
